    ...
    tone === "gold"
      ...
      : tone === "steam"
        ...
        : tone === "portafilter"
          ? styles.porta
          : styles.hazard;
  return <Animated.View pointerEvents="none" style={[look, styles.sprite, anim]} />;
});
...
const styles = StyleSheet.create({
  ...
  steam: { backgroundColor: "#D4B89A", borderRadius: 8 },
  porta: { backgroundColor: t.kraft, borderRadius: 8 },
  hint: {
    position: "absolute",
    left: 20,
    right: 20,
