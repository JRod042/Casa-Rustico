...
1. [expo.dev → casa-rustico-go → Credentials → iOS](https://expo.dev/accounts/jrod42/projects/casa-rustico-go/credentials)
2. For **`com.jrod042.casarusticogo`** open **App Store** (not Ad Hoc) when targeting TestFlight
